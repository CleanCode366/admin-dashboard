 ...
 */
export type ModerationReportActionTaken =
  (typeof ModerationReportActionTaken)[keyof typeof ModerationReportActionTaken]

export const ModerationReportActionTaken = {
  NONE: 'NONE',
  WARN: 'WARN',
