...
;(function (_) {
  ...
  */
   ...
   SPDX-License-Identifier: Apache-2.0
  */
    var ba, ea, va, ya, Fa, Ka, La, Oa, Pa, Qa, Sa, cb, fb, gb, hb, ib, w, jb, mb, ob, sb
    _.aa = function (a, b) {
    ...
    _.$a = function (a) {
      var b, c
      return (a =
        null == (c = (b = a.document).querySelector) ? void 0 : c.call(b, 'script[nonce]'))
    ...
    w = function (a, b) {
      if (b)
        a: {
          ...
          d = c[a]
          b = b(d)
          b != d && null != b && gb(c, a, { configurable: !0, writable: !0, value: b })
        }
    }
    w('Symbol', function (a) {
      if (a) return a
    ...
    w('Promise', function (a) {
      ...
      e.race = function (g) {
        return new e(function (h, l) {
          for (var m = _.x(g), n = m.next(); !n.done; n = m.next()) c(n.value).Kc(h, l)
        })
      }
      e.all = function (g) {
        var h = _.x(g),
        ...
        return l.done
          ...
          : new e(function (m, n) {
              ...
              var p = [],
                q = 0
              do (p.push(void 0), q++, c(l.value).Kc(r(p.length - 1), n), (l = h.next()))
              while (!l.done)
            })
      }
      return e
    ...
    w('Map', function (a) {
      ...
      c.prototype.set = function (h, l) {
        ...
        m.wa
          ? (m.wa.value = l)
          : ((m.wa = { next: this[1], fb: this[1].fb, head: this[1], key: h, value: l }),
            m.list.push(m.wa),
            (this[1].fb.next = m.wa),
            (this[1].fb = m.wa),
            this.size++)
    ...
    _.ec = Array.prototype.map
      ...
      : function (a, b, c) {
          for (
            var d = a.length, e = Array(d), f = 'string' === typeof a ? a.split('') : a, g = 0;
            g < d;
            g++
          )
    ...
    _.Ed = function (a, b) {
      ...
      if (a) {
        ...
        d
          ...
          : ((this.offsetX = _.tc || void 0 !== a.offsetX ? a.offsetX : a.layerX),
            (this.offsetY = _.tc || void 0 !== a.offsetY ? a.offsetY : a.layerY),
        ...
        this.pointerType =
          'string' === typeof a.pointerType ? a.pointerType : Dd[a.pointerType] || ''
        this.state = a.state
    ...
    _.G = function (a, b, c, d, e) {
      ...
      c = Sd(c)
      return _.Gd(a) ? a.I(b, c, _.wa(d) ? !!d.capture : !!d, e) : Td(a, b, c, !1, d, e)
    }
    Td = function (a, b, c, d, e, f) {
      ...
      if (a.addEventListener)
        (Cd || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e))
    ...
    _.Rd = function (a, b, c, d, e) {
      ...
      c = Sd(c)
      return _.Gd(a) ? a.qb(b, c, _.wa(d) ? !!d.capture : !!d, e) : Td(a, b, c, !0, d, e)
    }
    _.Yd = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) _.Yd(a, b[f], c, d, e)
        ...
        ((d = _.wa(d) ? !!d.capture : !!d),
          (c = Sd(c)),
          _.Gd(a) ? a.Ra(b, c, d, e) : a && (a = _.Ud(a)) && (b = a.mc(b, c, d, e)) && _.Zd(b))
    }
    _.Zd = function (a) {
    ...
    _.k.dispatchEvent = function (a) {
      ...
      a.h ||
        ((g = a.currentTarget = c), (e = ae(g, d, !0, a) && e), a.h || (e = ae(g, d, !1, a) && e))
      if (b)
    ...
    var ce = function (a) {
      ...
      ;(this.g = this.j.matchMedia
        ? this.j.matchMedia('(min-resolution: 1.5dppx), (-webkit-min-device-pixel-ratio: 1.5)')
        : null) &&
        ...
        'undefined' === typeof a &&
          ...
          (a = function () {
            ...
            var g = 'callImmediate' + Math.random(),
              h =
                'file:' == f.location.protocol ? '*' : f.location.protocol + '//' + f.location.host
            e = (0, _.A)(function (l) {
          ...
          if (a.j) {
            ...
            if (c.h) {
              ...
              e &&
                (0 == c.g && 1 == d
                  ? ze(c, b)
                  : (f ? ((d = f), d.next == c.l && (c.l = d), (d.next = d.next.next)) : Ae(c),
                    Be(c, e, 3, b)))
            }
            a.j = null
          } else _.se(a, 3, b)
  ...
  */
        ...
        for (var d = (c = !1); a.s.length && !a.B; ) {
          ...
          if ((f = a.l ? g : f))
            try {
              ...
              if (re(b) || ('function' === typeof _.t.Promise && b instanceof _.t.Promise))
                ((d = !0), (a.B = !0))
            } catch (l) {
              ;((b = l), (a.l = !0), Te(a) || (c = !0))
            }
    ...
    _.k.Ee = function (a, b) {
      if (!(this instanceof Ye)) this.Ee(a, b)
        ...
        for (var c = [], d = 0; d < a.length; d++) {
          ...
          c.push(f)
          this.g[f]
            ? ((f = this.g[f].h), f != e && f.splice.apply(f, [0, f.length].concat(_.lb(e))))
            : (this.g[f] = new Wb(e, f))
        }
    ...
    var bf = function (a) {
      ...
      cf = function (a, b, c, d, e) {
        ...
        df(a, b) ? d && (_.u(a.A, b) || a.A.push(b), bf(a)) : d && (_.u(a.A, b) || a.A.push(b))
      }
    ...
    var ff = function (a, b) {
      ...
      $e = function (a) {
        a.j == a.F &&
          ((a.j = null), a.F.onLoad((0, _.A)(a.yf, a)) && gf(a, new Db.Ja(Db.Ja.g.Dd)), bf(a))
      },
      na = function (a) {
        if (a.j) {
          var b = a.j.Ma(),
    ...
    Ye.prototype.og = function (a) {
      this.j ||
        ((this.g.synthetic_module_overhead = new Wb([], 'synthetic_module_overhead')),
    ...
    _.uf.prototype.delete = function (a) {
      return wf(this.h, a)
        ? (delete this.h[a], --this.size, this.j++, this.g.length > 2 * this.size && vf(this), !0)
        : !1
    }
    var vf = function (a) {
    ...
    Sf = function (a, b, c) {
      if (Array.isArray(b)) for (var d = 0; d < b.length; d++) Sf(a, String(b[d]), c)
    ...
    _.k.Ca = function (a) {
      og(this)
      var b = []
      if ('string' === typeof a) qg(this, a) && (b = b.concat(this.g.get(pg(this, a))))
      else {
    ...
    _.rg = function (a, b, c) {
      a.remove(b)
      0 < c.length && ((a.j = null), a.g.set(pg(a, b), _.ua(c)), (a.h += c.length))
    }
    ...
    _.sg.prototype.ya = function (a) {
      a = a({}, this.j ? this.j.g() : {})
      this.h(null, 'function' == typeof _.tg && a instanceof _.tg ? a.zb : null)
    }
    ...
    var zg = function (a) {
      var b = a.split('.')
      b = (4 !== b.length && 3 !== b.length) || -1 !== b[0].indexOf('=') ? null : new yg(b)
    ...
    _.I.prototype.Ra = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.Ra(a, b[f], c, d, e)
      else
        ((c = c || this.handleEvent),
          ...
          (c = Sd(c)),
          (d = !!d),
          (b = _.Gd(a) ? a.mc(b, c, d, e) : a ? ((a = _.Ud(a)) ? a.mc(b, c, d, e) : null) : null),
    ...
    _.Zg.prototype.send = function (a, b, c, d) {
      ...
      try {
        ;(dh(this),
          0 < this.o &&
            ((this.M = eh(this.g))
              ? ((this.g.timeout = this.o), (this.g.ontimeout = (0, _.A)(this.U, this)))
    ...
    _.Zg.prototype.J = function () {
      this.g &&
        (this.h && ((this.h = !1), (this.j = !0), this.g.abort(), (this.j = !1)), gh(this, !0))
      _.Zg.O.J.call(this)
    }
    ...
    var hh = function (a) {
        if (a.h && 'undefined' != typeof xb && (!a.D[1] || 4 != _.ih(a) || 2 != a.Na()))
    ...
    var mh = function (a, b, c, d, e) {
      ...
      nh = function (a, b, c, d, e) {
        ...
        for (
          var h = function (r, p) {
              for (var q = [], y = 0, D = Math.floor(r.length / p) + 1, S = 0; S < p; S++) {
                var T = (S + 1) * D
                q.push(r.slice(y, T))
                y = T
              }
      ...
      rh = function (a, b, c, d) {
        ...
        else for (a = 0; a < b.length; a++) ((d = b[a]), uh(d.o, d.Ga) || (c && c(8001)))
        ;(e || g) &&
          -1 != f &&
          _.cc(h, function (m) {
            m.cancel()
    ...
    var ph = function (a, b, c, d) {
        ...
        if (0 < a.j.length && !_.u(a.j, e) && null != e && window.location.hostname != e)
          throw Error('ba`' + e)
        e = Kg(a.A.toString())
        delete e.g.m
        delete e.g.exm
    ...
    Hf({
      ...
      initialize: function (a) {
        ...
        e || (e = vh(zh))
        e || ((e = document.getElementsByTagName('script')), (e = vh(e[e.length - 1].src)))
        if (!e) throw Error('aa')
        e = new kh(e)
        c && (e.o = c)
        d && (e.l = d)
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.en_US.9FtKg9_zuVQ.O/am=wA/d=1/rs=AN8SPfonqB2aH9dq5BogimmncCM1ZH50lA/m=el_conf
// Configure Constants
;(function () {
  ...
  ;(function () {
    ...
    _loadCss(c._ps)
    _loadJs(
      'https:\/\/translate.googleapis.com\/_\/translate_http\/_\/js\/k\x3dtranslate_http.tr.en_US.9FtKg9_zuVQ.O\/d\x3d1\/exm\x3del_conf\/ed\x3d1\/rs\x3dAN8SPfpH4pqDgALX4XSkV8ojdWyFG6usLw\/m\x3del_main'
    )
    _exportMessages()
    _exportVersion('TE_20240306')
  })()
})()
