...
export function ReportCard({
  ...
  return (
    <ListCard
      ...
      footer={
        isClaimed ? (
          <div className="text-text-warning text-sm">🔒 Being reviewed by {claimedBy}</div>
        ) : (
          <>
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="bg-bg-secondary text-text-secondary space-y-2 rounded-lg p-4 text-xs">
