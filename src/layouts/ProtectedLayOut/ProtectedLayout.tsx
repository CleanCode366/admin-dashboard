  ...
  if (isLoading)
    return (
      <div style={{ minHeight: '62vh' }}>
        <div className="w-100% flex h-110 flex-col items-center justify-center gap-4">
          {/* <FaSpinner className="animate-spin text-4xl text-[#66B0FF]" /> */}
          <img
            src={cdacRoundLogo}
            className="cdacSpinner mr-3 mb-4 size-20"
            alt="Loading spinner"
          />
          <div className="text-lg text-[#000000]">Loading...</div>
        </div>
      </div>
    )
